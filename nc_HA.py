...
class NetCat:
    ...
    def handle(self, client_socket):
        if self.args.execute:
            ...
            while True:
                try:
                    client_socket.send(b'InfoSec-HA:#> ')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='InfoSec-HA netcat tool with python', 
...
parser.add_argument('-p', '--port', type=int, default=5555, help='specified port by default is 5555')
